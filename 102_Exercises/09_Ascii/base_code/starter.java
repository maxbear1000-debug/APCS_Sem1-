...
class starter {
	public static void main(String args[]) {
		...
		System.out.print("Animal, Object, or Face:  "); 
		String second = sc.nextLine();
		if(second.equals("animal") || second.equals("animal")){
			System.out.println("""
              .'`   `,
            .'_.  ._  `;.
        __ / `      `  `.| .--.
      ...
      |    ;.-----.__ _-');   /
       '--./         `.`/  `'`
		...
		else if(second.equals("object") || second.equals("Object")){
			System.out.println("""    
   _,-="=-._  ,-- 
{   {-O=O-}   }
 '===|{_}/==='
     ...
     (()))""");
		...
		else if(second.equals("face") || second.equals("Face")){
			System.out.println("""
