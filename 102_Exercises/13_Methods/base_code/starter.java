...
class starter {
	...
	public static int getDigitSum(int num){
		return ((num/10000)%10)+((num/1000)%10)+((num/100)%10)+((num/10)%10)+((num/1)%10);
	...
	public static void printIfConsecutive(int a, int b, int c){
		if(c == a+2 && b==a+1){
			System.out.println("These numbers are consectuive");
		}
		else{
			System.out.println("These numbers are not consectuvie");
		}
