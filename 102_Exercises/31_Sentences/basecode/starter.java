...
class starter {
	public static void main(String args[]) {
		...
		System.out.println(words[0][0] + " "+ words[1][0] +" " +words[2][0] +" " +words[3][0] + " " + words[3][0]);
		...
		System.out.println(words[0][0] + " "+ words[1][0] +" " +words[2][0] +" " +words[3][0] + " " + words[3][0]);
		System.out.println(words[0][1] + " "+ words[1][3] +" " +words[2][2] +" " +words[3][3] + " " + words[4][0]);
		System.out.println(words[0][2] + " " + words[1][2] + " " +   words[2][2] +" " + words[2][0]  + " " + words[3][3]+ " " +words[4][2]);
